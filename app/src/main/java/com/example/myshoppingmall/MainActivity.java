...
public class MainActivity extends AppCompatActivity
    ...
    private static final int ORDERS_FEAGMENT = 2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (showCart) {
            drawer.setDrawerLockMode(DrawerLayout.LOCK_MODE_LOCKED_CLOSED); //drawer.setDrawerLockMode(1)
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if(currentUser != null) {
            ...
            if (id == R.id.nav_my_mall) {
                ...
                gotoFragment("My Orders", new MyOrdersFragment(), ORDERS_FEAGMENT);
